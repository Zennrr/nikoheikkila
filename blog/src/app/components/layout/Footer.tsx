                            ...
                            {latestPosts.map((post) => (
                                <li key={post.filename}>
                                    <Link
                                        ...
                                        className="line-clamp-1 text-blue-200 transition-colors hover:text-blue-400"
                                    >
                                        {post.title}
                                    </Link>
                                </li>
                        ...
                        {featuredPost ? (
                            <div>
                                <Link
                                    ...
                                    className="font-medium text-blue-200 transition-colors hover:text-blue-400"
                                >
                                    {featuredPost.title}
                                </Link>
                        ...
                        <ul className="m-0 list-none space-y-1 space-y-2 p-0 text-xl text-blue-100 no-underline">
                            <li>
                                <a
                                    ...
                                    className="flex items-center text-blue-200 no-underline transition-colors hover:text-blue-400"
                                >
                                    <svg
